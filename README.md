...
chaos. It also allows them to place orders so the order can be prepared in advance, 
the availability of the required resources can be checked, and then the order can be 
started immediately once the customer arrives.
